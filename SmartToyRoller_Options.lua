...
local function CreateOptionsPanel()
	...
	CreateBorderBox(panel, 216, -214, 378, 62)
	CreateBorderBox(panel, 216, -282, 378, 338)
	...
	panel.addGroup = CreateButton(panel, "新建分组", GROUP_X + 10, -242, 76)
	panel.addGroup:SetScript("OnClick", AddGroup)
	panel.deleteGroup = CreateButton(panel, "删除分组", GROUP_X + 90, -242, 76)
	panel.deleteGroup:SetScript("OnClick", DeleteGroup)
	panel.groupUp = CreateButton(panel, "上移", GROUP_X + 170, -242, 54)
	panel.groupUp:SetScript("OnClick", function()
		MoveGroup(-1)
	end)
	panel.groupDown = CreateButton(panel, "下移", GROUP_X + 228, -242, 54)
	panel.groupDown:SetScript("OnClick", function()
		MoveGroup(1)
	end)

	CreateLabel(panel, "分组", GROUP_X + 10, -290)
	...
	panel.groupToyScroll:SetSize(348, 252)
